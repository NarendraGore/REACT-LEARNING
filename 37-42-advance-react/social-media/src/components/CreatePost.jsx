...
const CreatePost = () => {
  ...
  const handleSubmit = (event) => {
    ...
    viewElement.current.value = "";
    return addPost(userId, postTitle, postBody, reactions, tags, views);
  };
